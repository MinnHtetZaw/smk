        ...
        <div class="col-auto px-0 ">
            <div id="sidebar" class="collapse collapse-horizontal show border-end ">
                ...
                <div class="nav flex-column nav-pills w-100 " id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <button class="nav-link m-3 active" id="v-pills-profile-tab" data-bs-toggle="pill" data-bs-target="#v-pills-pri" type="button" role="tab" aria-controls="v-pills-profile" aria-selected="false">Primary-School</button>
...
<th style="vertical-align : middle;text-align:center;" rowspan="5" scope="rowgroup"> Pre School</th>
   ...
   <td  >{{index + 1}}</td>
    ...
    <div class="tab-pane fade show active" id="v-pills-pri" role="tabpanel" aria-labelledby="v-pills-profile-tab" tabindex="0">
